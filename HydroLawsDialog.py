...
dico_typ_law = {1: {'name': 'Hydrograph Q(t)',
                ...
                #     'var': [{'name': 'flowrate', 'leg': 'Q', 'unit': 'm3/s'},
                #             {'name': 'level am', 'leg': 'Zam', 'unit': 'm'},
                #             {'name': 'level av', 'leg': 'Zav', 'unit': 'm'}],
                #     'graph': None,
                #     'xIsTime': False},
                7: {'name': 'Floodgate Zinf, Zsup = f(t)',
                    'var': [{'name': 'time', 'leg': 'time', 'unit': 's'},
                            {'name': 'level inf', 'leg': 'Zinf', 'unit': 'm'},
                            {'name': 'level sup', 'leg': 'Zsup', 'unit': 'm'}],
                    'graph': {'x': {'var': 0, 'tit': 'time', 'unit': 's'},
