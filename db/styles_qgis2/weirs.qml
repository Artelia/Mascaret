...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="200000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="type">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="Downstream rating curve weir(Abacuses (Q, Zav))" value="7"/>
        <value key="Floodgate" value="8"/>
        <value key="Geometric weir (Crest profile)" value="3"/>
        <value key="Limni upstream weir (Abacuses (Zam, t))" value="5"/>
        <value key="Rating curve weir (Abacuses Zam/Zav/Q)" value="1"/>
        <value key="Rating curve weir (Abacuses Zam=f(Q))" value="2"/>
        <value key="Upstream rating weir( (Abacuses Q=f(Zam))" value="6"/>
        <value key="Weir law" value="4"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="Range" name="branchnum">
      <widgetv2config AllowNull="0" fieldEditable="1" Step="1" constraint="" Style="SpinBox" labelOnTop="0" constraintDescription="" Min="1" notNull="0" Max="20"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="abscissa">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="z_crest">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="z_average_crest">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="z_break">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="flowratecoeff">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="ValueMap" name="thickness">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="thick" value="1"/>
        <value key="thin" value="2"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="TextEdit" name="wide_floodgate">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="FileName" name="lawfile">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="abscissa"/>
  ...
  <displayfield>&lt;img src="Z:\modelisation\mascaret\sarthe_amont\photos\[% "nom" %]" /></displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <LinearlyInterpolatedDiagramRenderer upperValue="0" lowerHeight="0" upperHeight="50" lowerValue="0" diagramType="Text" upperWidth="50" classificationAttributeExpression="" lowerWidth="0" sizeLegend="0" attributeLegend="1">
    <DiagramCategory penColor="#000000" labelPlacementMethod="XHeight" penWidth="0" diagramOrientation="Up" sizeScale="0,0,0,0,0,0" minimumSize="0" barWidth="5" penAlpha="255" maxScaleDenominator="200000" backgroundColor="#ffffff" transparency="0" width="15" scaleDependency="Area" backgroundAlpha="255" angleOffset="1440" scaleBasedVisibility="1" enabled="1" height="15" lineSizeScale="0,0,0,0,0,0" sizeType="MM" lineSizeType="MM" minScaleDenominator="100000">
      <fontProperties description=",8.25,-1,5,50,0,0,0,0,0" style=""/>
      <attribute field="&quot;abscissa&quot;" color="#04a3d0" label="&quot;abscissa&quot;"/>
      <attribute field="&quot;branchnum&quot;" color="#254877" label="&quot;branchnum&quot;"/>
    </DiagramCategory>
  ...
  <DiagramLayerSettings yPosColumn="-1" showColumn="0" linePlacementFlags="0" placement="0" dist="0" xPosColumn="-1" priority="0" obstacle="0" zIndex="0" showAll="0"/>
  <annotationform>.</annotationform>
  <aliases>
    <alias field="gid" index="0" name=""/>
    <alias field="name" index="1" name=""/>
    <alias field="type" index="2" name=""/>
    <alias field="branchnum" index="3" name=""/>
    <alias field="abscissa" index="4" name=""/>
    <alias field="z_crest" index="5" name=""/>
    <alias field="z_average_crest" index="6" name=""/>
    <alias field="z_break" index="7" name=""/>
    <alias field="flowratecoeff" index="8" name=""/>
    <alias field="thickness" index="9" name=""/>
    <alias field="wide_floodgate" index="10" name=""/>
    <alias field="lawfile" index="11" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="z_crest"/>
      <column width="-1" hidden="0" type="field" name="z_average_crest"/>
      <column width="-1" hidden="0" type="field" name="z_break"/>
      <column width="-1" hidden="0" type="field" name="flowratecoeff"/>
      <column width="-1" hidden="0" type="field" name="thickness"/>
      <column width="-1" hidden="0" type="field" name="wide_floodgate"/>
      <column width="-1" hidden="0" type="field" name="lawfile"/>
      <column width="-1" hidden="0" type="field" name="active"/>
      <column width="-1" hidden="1" type="actions"/>
    </columns>
  </attributetableconfig>
  <editform>../../../../Qt/qtcreator-2.4.1/dialog.ui</editform>
  <editforminit/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Abacuses" groupBox="0" columnCount="0">
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Break" groupBox="1" columnCount="0">
        <attributeEditorField showLabel="1" index="5" name="z_crest"/>
        <attributeEditorField showLabel="1" index="7" name="z_break"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Crest profile" groupBox="0" columnCount="0">
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Weir characteristics" groupBox="1" columnCount="0">
    ...
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Weir law" groupBox="0" columnCount="0">
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Weir characteristics" groupBox="1" columnCount="0">
        <attributeEditorField showLabel="1" index="5" name="z_crest"/>
        <attributeEditorField showLabel="1" index="8" name="flowratecoeff"/>
    ...
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Floodgate" groupBox="0" columnCount="0">
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Weir characteristics" groupBox="1" columnCount="0">
  ...
  <defaults>
    ...
    <default field="z_crest" expression=""/>
    <default field="z_average_crest" expression=""/>
    <default field="z_break" expression=""/>
    <default field="flowratecoeff" expression=""/>
    <default field="thickness" expression=""/>
    <default field="wide_floodgate" expression=""/>
    <default field="lawfile" expression=""/>
