...
<qgis readOnly="0" simplifyDrawingHints="0" version="3.16.7-Hannover" simplifyMaxScale="1" simplifyDrawingTol="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="0" maxScale="0" minScale="200000" labelsEnabled="0" simplifyLocal="1">
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" forceraster="0" type="categorizedSymbol" attr="active">
    <categories>
      <category label="active" symbol="0" render="true" value="true"/>
      <category label="inactive" symbol="1" render="true" value="false"/>
    </categories>
    <symbols>
  ...
  <fieldConfiguration>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="Limnihydro water level and flow rate" type="QString" value="8"/>
              </Option>
              <Option type="Map">
                <Option name="Normal Height" type="QString" value="7"/>
              </Option>
              <Option type="Map">
                <Option name="Free evacuation" type="QString" value="6"/>
              </Option>
              <Option type="Map">
                <Option name="Regulation law" type="QString" value="5"/>
              </Option>
              <Option type="Map">
                <Option name="Taring curve Q=f(Z)" type="QString" value="4"/>
              </Option>
              <Option type="Map">
                <Option name="Taring curve Z=f(Q)" type="QString" value="3"/>
              </Option>
              <Option type="Map">
                <Option name="Limnigraph" type="QString" value="2"/>
              </Option>
              <Option type="Map">
                <Option name="Junction" type="QString" value="10"/>
              </Option>
              <Option type="Map">
                <Option name="Hydrograph" type="QString" value="1"/>
              </Option>
              <Option type="Map">
                <Option name="Dam/Weir Zam=f(Q,Zav)" type="QString" value="0"/>
              </Option>
            </Option>
          </Option>
        </config>
    ...
    <field name="ordinates" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="angles" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="tracer_boundary_condition_type" configurationFlags="None">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="Neumann" type="QString" value="1"/>
              </Option>
              <Option type="Map">
                <Option name="Dirichlet" type="QString" value="2"/>
              </Option>
            </Option>
          </Option>
        </config>
    ...
    <field name="law_wq" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
  ...
  <aliases>
    ...
    <alias index="3" name="" field="method"/>
    <alias index="4" name="steadyValue" field="firstvalue"/>
    <alias index="5" name="" field="abscissa"/>
    <alias index="6" name="" field="ordinates"/>
    <alias index="7" name="" field="angles"/>
    <alias index="8" name="" field="active"/>
    <alias index="9" name="" field="tracer_boundary_condition_type"/>
    <alias index="10" name="" field="law_wq"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" field="ordinates" expression=""/>
    <default applyOnUpdate="0" field="angles" expression=""/>
    <default applyOnUpdate="0" field="active" expression=""/>
    <default applyOnUpdate="0" field="tracer_boundary_condition_type" expression=""/>
    <default applyOnUpdate="0" field="law_wq" expression=""/>
  </defaults>
  <constraints>
    <constraint unique_strength="1" constraints="3" exp_strength="0" field="gid" notnull_strength="1"/>
    <constraint unique_strength="1" constraints="2" exp_strength="0" field="name" notnull_strength="0"/>
    ...
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="ordinates" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="angles" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="active" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="tracer_boundary_condition_type" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="law_wq" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="ordinates"/>
    <constraint exp="" desc="" field="angles"/>
    <constraint exp="" desc="" field="active"/>
    <constraint exp="" desc="" field="tracer_boundary_condition_type"/>
    <constraint exp="" desc="" field="law_wq"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column hidden="0" name="ordinates" type="field" width="-1"/>
      <column hidden="0" name="angles" type="field" width="-1"/>
      <column hidden="0" name="active" type="field" width="-1"/>
      <column hidden="1" type="actions" width="-1"/>
      <column hidden="0" name="tracer_boundary_condition_type" type="field" width="-1"/>
      <column hidden="0" name="law_wq" type="field" width="-1"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer visibilityExpressionEnabled="0" visibilityExpression="" name="infos" columnCount="0" showLabel="1" groupBox="0">
      ...
      <attributeEditorField index="8" name="active" showLabel="1"/>
    </attributeEditorContainer>
    <attributeEditorContainer visibilityExpressionEnabled="0" visibilityExpression="" name="junctions" columnCount="0" showLabel="1" groupBox="0">
      <attributeEditorField index="5" name="abscissa" showLabel="1"/>
      <attributeEditorField index="6" name="ordinates" showLabel="1"/>
      <attributeEditorField index="7" name="angles" showLabel="1"/>
    </attributeEditorContainer>
    <attributeEditorContainer visibilityExpressionEnabled="0" visibilityExpression="" name="others" columnCount="0" showLabel="1" groupBox="0">
      <attributeEditorField index="3" name="method" showLabel="1"/>
      <attributeEditorField index="4" name="firstvalue" showLabel="1"/>
    </attributeEditorContainer>
    <attributeEditorContainer visibilityExpressionEnabled="0" visibilityExpression="" name="Water Quality" columnCount="1" showLabel="1" groupBox="0">
      <attributeEditorField index="10" name="law_wq" showLabel="1"/>
      <attributeEditorField index="9" name="tracer_boundary_condition_type" showLabel="1"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <editable>
    ...
    <field editable="1" name="law_wq"/>
    <field editable="1" name="method"/>
    <field editable="1" name="name"/>
    <field editable="1" name="ordinates"/>
    <field editable="1" name="tracer_boundary_condition_type"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="law_wq"/>
    <field labelOnTop="0" name="method"/>
    <field labelOnTop="0" name="name"/>
    <field labelOnTop="0" name="ordinates"/>
    <field labelOnTop="0" name="tracer_boundary_condition_type"/>
