...
<qgis version="2.18" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <attributeEditorForm>
    <attributeEditorContainer name="infos">
      ...
      <attributeEditorField index="5" name="length"/>
      <attributeEditorField index="8" name="active"/>
    </attributeEditorContainer>
    <attributeEditorContainer name="Crest height and flow rate coeff">
      <attributeEditorField index="6" name="z_crest"/>
      <attributeEditorField index="7" name="flowratecoef"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <attributeactions/>
</qgis>
