...
class ClassDictRun:
    ...
    def fill_lscenario(self, data):
        ...
        # def fill_lscenario_old(self, kernel, name_run):
        #     """
        #     #TODO delete
        #     Initializes the 'run' dictionary with model parameters and retrieves associated scenarios.
        #     """
        ...
        #     scenarios = []
        #     if self.dmodel.get("run"):
        #         scenarios = self.creat_lscenar_old()
        #     self.dmodel['scenario'] = scenarios
        #
        ...
        #
        #         if not self.check_scenar(scen_name, name_run):
        #             self.mgis.add_info(f"Simulation canceled: scenario '{scen_name}' already exists.")
        #             continue
        #
        #         scenarios.append({
        ...
        #
        #     if not ok or not self.check_scenar(scen_name, name_run):
        #         self.mgis.add_info(f"Simulation canceled: scenario '{scen_name}' already exists.")
        #         return scenarios
        #
        #     scenarios.append({
