            ...
            'O2': {
                ...
                'physic': [
                    {'sigle': 'K1', 'text': 'KINETIC CONST. FOR ORGANIC LOAD DEPLETION  K1 (DAY-1)',
                     ...
                     'value': 0.25},
                    {'sigle': 'K4', 'text': 'KINETIC CONST. FOR NITRIFICATION K4 (DAY-1)',
                     'textfr': u"CONST. DE CINET. DE NITRIFICATION K4 (J-1)",
                     'value': 0.35},
                    {'sigle': 'BEN', 'text': 'BENTHIC OXYGEN DEMAND BEN (GO2/M2/DAY)',
                    ...
                    {'sigle': 'R', 'text': 'PLANT RESPIRATION R (MGO2/DAY/L)',
                     ...
                     'value': 0.06},
                    {'sigle': 'K2', 'text': 'OXYGEN REAERATION COEFF. K2 (DAY-1)',
                    ...
                    {'sigle': 'Cs', 'text': 'OXYGEN SATURATION CONCENTRATION IN THE WATER CS (MG/L)',
                     ...
                     'value': 9.0},
                    {'sigle': 'F_Cs', 'text': 'FORMULA FOR THE CONCENTRATION CS',
                     'textfr': u"FORMULE DE CALCUL DE CS",
                     'value': 0.},
                    {'sigle': 'T', 'text': 'WATER TEMPERATURE T ( C)',
                     'textfr': u"TEMPERATURE DE L'EAU T ( C)",
                     'value': 7.},
                    {'sigle': 'R_COEF', 'text': 'OXYGEN REAERATION COEFF. AT WEIRS R (.)',
                     'textfr': u"COEFFICIENT DE REAERATION AUX SEUILS R (.)",
                     'value': 0.},
                    {'sigle': 'F_R', 'text': 'FORMULA FOR THE REAERATION COEFF. r (.)',
            ...
            'EUTRO': {
                ...
                'physic': [
                    ...
                    {'sigle': 'K120',
                     ...
                     'value': 0.0},
                    {'sigle': 'K1', 'text': u'KINETIC CONST. FOR ORGANIC LOAD DEPLETION  K1 (DAY-1)',
                     'textfr': u"CONST. DE CINET. DE DEGRADATION DE LA CHARGE ORGANIQUE K120 (J-1)",
                     'value': 0.25},
                    {'sigle': 'K4', 'text': 'KINETIC CONST. FOR NITRIFICATION K4 (DAY-1)',
                     'textfr': u"CONST. DE CINET. DE NITRIFICATION K520 (J-1)",
                     'value': 0.35},
                    {'sigle': 'F', 'text': u'OXYGEN PRODUCED BY PHOTOSYNTHESIS F(MGO2 / MICROGCHLA)',
                    ...
                    {'sigle': 'N',
                     ...
                     'value': 5.2},
                    {'sigle': 'BEN', 'text': u'BENTHIC OXYGEN DEMAND BEN (GO2/M2/DAY)',
                     'textfr': u"DEMANDE BENTHIQUE BEN (GO2/M2/J)",
                     'value': 0.1},
                    {'sigle': 'K2', 'text': u'OXYGEN REAERATION COEFF. K2 (DAY-1)',
                     'textfr': u"COEFFICIENT DE REAERATION K2 (J-1)",
                     'value': 0.9},
                    {'sigle': 'F_K2', 'text': u'FORMULA FOR THE COEFFICIENT K2',
                     'textfr': u"FORMULE DE CALCUL DE K2",
                     'value': 0.},
                    {'sigle': 'Cs', 'text': u'OXYGEN SATURATION CONCENTRATION IN THE WATER CS (MG/L)',
                     'textfr': u"CONCENTRATION DE SATURATION EN OXYGENE DE L'EAU CS (MG/L)",
                     'value': 9.0},
                    {'sigle': 'F_Cs', 'text': u'FORMULA FOR THE CONCENTRATION CS',
                     'textfr': u"FORMULE DE CALCUL DE CS",
                     'value': 0.},
                    {'sigle': 'R_COEF', 'text': u'OXYGEN REAERATION COEFF. AT WEIRS R (.)',
                     'textfr': u"COEFFICIENT DE REAERATION AUX SEUILS R (.)",
                     'value': 0.},
                    {'sigle': 'F_R', 'text': u'FORMULA FOR THE REAERATION COEFF. r (.)',
                     'textfr': u"FORMULE DE CALCUL DE R",
                     'value': 1.},
                    {'sigle': 'N_W', 'text': u'NUMBER OF WEIRS N',
                     'textfr': u"NOMBRE DE SEUILS N",
                     'value': 0.},
                    {'sigle': 'A_COEF', 'text': u'COEFF. A IN THE FORMULA FOR R AT WEIR N 1',
                     'textfr': u"COEFFICIENT A DES FORMULES DE CALCUL DE R POUR LE SEUIL N 1",
                     'value': 1.2},
                    {'sigle': 'B_COEF', 'text': u'COEFF. B IN THE FORMULA FOR R IN WEIR N 1',
                     'textfr': u"COEFFICIENT B DES FORMULES DE CALCUL DE R POUR LE SEUIL N 1",
                     'value': 0.7},
                    {'sigle': 'NUM_W',
