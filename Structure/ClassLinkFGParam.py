    ...
    def __init__(self):
        ...
        self.lst_param = {
            ...
            "TOLREG": {"desc": "Tolerance sur les variale de regulation",
                       "default":0.05},
            "VBREAKREG": {"desc": "Valeur de rupture ouvrage",
                          "default": "0"},
            "BPERMREG": {"desc": "Si rupture permanent",
                          "default": True},
            "ZFINALREG": {"desc": "Cote final weirs après rupture",
                          "default": "0"},
            # meth_tempo
            ...
            "VALUEZ":{"desc": "Valeur associé à TIME",
                       "default":0},
            "VBREAKT": {"desc": "Valeur de rupture ouvrage",
                          "default": "0"},
            "BPERMT": {"desc": "Si rupture permanent",
                         "default": True},
            "ZFINALT": {"desc": "Cote final weirs après rupture",
                          "default": "0"},
